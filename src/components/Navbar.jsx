    ...
    <header className="navbar">
      <div className="navbar-inner">
        ...
        <nav className={`nav-links ${open ? "open" : ""}`}>
          <a href="/#kenapa" onClick={() => setOpen(false)}>Kenapa Kami</a>
          <a href="/#fitur" onClick={() => setOpen(false)}>Fitur</a>
          <a href="/#harga" onClick={() => setOpen(false)}>Harga</a>
          <a href="/#faq" onClick={() => setOpen(false)}>FAQ</a>
          <a href={waLink} target="_blank" rel="noreferrer" className="btn btn-primary nav-cta-mobile" onClick={() => setOpen(false)}>
            Konsultasi Gratis
          </a>
        </nav>

        <a href={waLink} target="_blank" rel="noreferrer" className="btn btn-primary nav-cta-desktop">
          Konsultasi Gratis
        </a>
